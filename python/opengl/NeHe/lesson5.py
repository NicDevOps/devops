...
# http://forge.cbp.ens-lyon.fr/redmine/projects/pyopengl4dummies/repository/revisions/9/entry/PyOpenGL-Demo/NeHe/lesson5.py
...
__date__ = ' '.join(str.split('$Date: 2007/02/15 19:25:21 $')[1:3])
